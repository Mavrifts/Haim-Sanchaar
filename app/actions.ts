...
// Multi-State Operational Fallback Data (Himachal Pradesh, Uttarakhand, Ladakh, Jammu & Kashmir)
const MULTI_STATE_FALLBACK: VillageData[] = [
  {
    id: 'HP-01',
    name: 'Spiti Valley Basin',
    district: 'Lahaul and Spiti',
    state: 'Himachal Pradesh',
    population: 1200,
    river_basin: 'Spiti River',
    latitude: 32.2432,
    longitude: 78.0245,
    risk_status: 'HIGH',
    evacuation_status: 'MONITORING',
    assigned_battalion: '7th Bn NDRF',
    safe_shelter: 'Kaza Higher Ground',
    alternate_routes: ['Gramphu-Kaza Road'],
    places_you_can_wait: ['Kaza Town Center'],
    emergency_numbers: ['NDRF: 1078'],
    live_telemetry: {
      sensor_id: 'TEL-HP-SPITI-01',
      water_level: 3650.20,
      danger_level: 3655.00,
      warning_level: 3652.00,
      rainfall_mm_hr: 5.2,
      soil_moisture_pct: 45.2,
      rate_of_rise: 0.02,
      flow_rate_cumecs: 120,
      battery_level: 92,
      status: 'NORMAL',
  ...
  },
  {
    ...
    assigned_battalion: '8th Bn NDRF',
    safe_shelter: 'Auli High Altitude Station',
    alternate_routes: ['Badrinath-Joshimath Highway'],
    places_you_can_wait: ['Joshimath Lower Ground'],
    emergency_numbers: ['NDRF: 1078', 'Chamoli Control: 01372-252115'],
    live_telemetry: {
      sensor_id: 'TEL-UK-JSH-01',
      water_level: 1850.50,
      danger_level: 1855.00,
      warning_level: 1852.00,
      rainfall_mm_hr: 25.4,
      soil_moisture_pct: 88.5,
      rate_of_rise: 0.35,
      flow_rate_cumecs: 800,
      battery_level: 72,
      status: 'CRITICAL',
      timestamp: new Date().toISOString(),
    },
  ...
  },
  {
    ...
    live_telemetry: {
      ...
      rainfall_mm_hr: 38.2,
      soil_moisture_pct: 92.2,
      rate_of_rise: 0.22,
      flow_rate_cumecs: 3200,
      battery_level: 78,
      status: 'HIGH',
      timestamp: new Date().toISOString(),
    },
