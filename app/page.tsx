    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <section className="border border-slate-300 rounded p-6 bg-white">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
          ...
          <button
            onClick={copySummary}
            className="rounded border border-slate-300 px-3 py-1 text-xs font-bold bg-slate-50 hover:bg-slate-100 flex items-center gap-2"
          >
        ...
        <div className="py-4 text-slate-700 text-sm leading-relaxed">
          {loading || isPending ? (
            <div className="text-slate-500 italic">Syncing briefing data...</div>
          ) : (
